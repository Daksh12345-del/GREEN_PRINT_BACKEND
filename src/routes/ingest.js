...
router.post("/logs", requireDeviceKey, async (req, res) => {
  try {
    ...
    const result = await query(
      `INSERT INTO logs (company_id, facility_id, vehicle_id, activity_type, quantity, unit, renewable_share, source, device_id)
       VALUES ($1,$2,$3,$4,$5,$6,$7,'device',$8) RETURNING *`,
      [
        device.company_id,
        device.facility_id,
        device.vehicle_id,
    ...
    const emissions = computeLogEmissions(result.rows[0], company.region, factorMap);
