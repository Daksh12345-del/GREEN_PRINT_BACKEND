...
// `npm start`). When required as a module (e.g. by the test suite), it
// just exports `app` so tests can attach their own listener and control
// exactly when the database is migrated/reset.
